...
export default function CareersEditor({ pageId, data, setData }: { pageId: string, data: any, setData: (d: any) => void }) {
  ...
  useEffect(() => {
    if (data && Object.keys(data).length === 0) {
       setData({
         careers: {
           section: { badge: "Join Christmas Lights Over Columbus", headline: "Expert hands with Visionary minds", description: "Build your future with a team that values precision, integrity, and craftsmanship." },
           roles: [
             { label: "Installation Specialist", value: "installer" },
             { label: "Design Consultant", value: "designer" },
