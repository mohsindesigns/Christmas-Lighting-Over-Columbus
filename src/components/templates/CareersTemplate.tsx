...
export default function CareersTemplate({ pageData, params }: { pageData?: any, params?: any }) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("_subject", "New Job Application - Christmas Lights Over Columbus");
    ...
    try {
      ...
      const emailContent = `
NEW JOB APPLICATION - CHRISTMAS LIGHTS OVER COLUMBUS
----------------------------------
Name: ${name}
Email: ${email}
Phone: ${phone}
...
(Note: Please attach your resume manually to this email)
      ...
      const mailtoLink = `mailto:info@lightsovercolumbus.com?subject=Job Application - ${name}&body=${encodeURIComponent(emailContent)}`;
        ...
        <div className="max-w-5xl mx-auto px-4 relative z-30">
          <div className="max-w-3xl mx-auto text-center mb-12 md:mb-24">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex items-center justify-center gap-3 mb-6">
              ...
              <span className="text-xs font-medium tracking-[0.2em] uppercase text-blue-600">{careersData?.section?.badge || "Join Christmas Lights Over Columbus"}</span>
