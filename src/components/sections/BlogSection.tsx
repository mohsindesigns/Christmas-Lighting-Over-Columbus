...
export default function BlogSection({ 
    ...
    const displayDescription = hasTextContent(description) ? description! : "Stay updated with the latest trends, tips, and inspiration from holiday and Christmas lighting.";
