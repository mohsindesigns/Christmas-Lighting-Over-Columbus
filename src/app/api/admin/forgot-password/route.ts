  ...
  try {
    ...
    try {
      await transporter.sendMail({
        from: `"Christmas Lights Over Columbus" <${process.env.SMTP_USER}>`,
        to: user.email,
        subject: 'Password Reset Request - Christmas Lights Over Columbus',
        html: `
          <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
            ...
            <div style="padding: 30px; text-align: center;">
              <p style="color: #64748b; font-size: 16px; margin-bottom: 30px;">
                You requested a password reset for your Christmas Lights Over Columbus Admin account. Click the button below to set a new password. This link will expire in 1 hour.
              </p>
